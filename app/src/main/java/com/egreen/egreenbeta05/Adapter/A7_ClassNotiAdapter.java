...
public class A7_ClassNotiAdapter extends RecyclerView.Adapter {
    private static final String TAG = A7_ClassNotiAdapter.class.getSimpleName();

    Context context;
    ArrayList<A7_ClassNotiData> data;
    private ClassNotiListener mListener;

    public A7_ClassNotiAdapter(Context context, ArrayList<A7_ClassNotiData> data) {
