...
public class A7_HomeAttendAdapter extends RecyclerView.Adapter {
    private static final String TAG = A7_HomeAttendAdapter.class.getSimpleName();

    Context context;
    ArrayList<AttendStateData> data;
    private AttendStateClickListener mListener;

    public A7_HomeAttendAdapter(Context context, ArrayList<AttendStateData> data) {
