...
public class A6_MyClassListData {
    boolean isEnable;
    String classId;
    String classTitle;
    String studyDate;
    ...
    public A6_MyClassListData(boolean isEnable, String classId, String classTitle, String studyDate, String attendRatio, String isReadOrientation,
