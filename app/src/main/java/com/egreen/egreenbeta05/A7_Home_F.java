...
import com.egreen.egreenbeta05.Data.AttendStateData;
 ...
 * {@link A7_Home_F.OnFragmentHomeListener} interface
 * to handle interaction events.
 * Use the {@link A7_Home_F#newInstance} factory method to
 * create an instance of this fragment.
 */
public class A7_Home_F extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = A7_Home_F.class.getSimpleName();
    ...
    public static A7_Home_F newInstance(String param1, String param2) {
        A7_Home_F fragment = new A7_Home_F();
...
//        Log.i(TAG, "공지사항 =======> " + s);
        ArrayList<A7_ClassNotiData> arrJucaRatioData = (ArrayList<A7_ClassNotiData>) getArguments().get("NOTI_INFO");

        LinearLayoutManager linearLayout = new LinearLayoutManager(getActivity());
        A7_ClassNotiAdapter a7_classNotiAdapter = new A7_ClassNotiAdapter(getActivity(), arrJucaRatioData);
...
//                Log.i(TAG, "Ratio :::> " + ratio);
        ...
        A7_HomeAttendAdapter a7_HomeAttendAdapter = new A7_HomeAttendAdapter(getActivity(), arrAttendStateData);
