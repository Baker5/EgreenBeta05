...
/**
 * Created by JDirectory on 2018. 3. 23..
 */
    ...
    public String request(String _url, ContentValues _params) {
        ...
        try{
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_OK) {
                Log.i(TAG, "연결 실패: " + conn.getResponseMessage());
                return "FAIL";
            }
            else {
                //연결 성공
                Log.i(TAG, "연결 성공: " + conn.getResponseMessage());
            }
